        ...
        <nav className='text-white bg-black shadow-inner shadow-white flex justify-between items-center px-5 h-20'>
            ...
            <div className='relative'>
                {session && <>
                    ...
                    <div id="dropdownAvatarName" className={`z-10 ${showDropDown ? '' : 'hidden'} bg-black absolute right-2 my-6 bg-neutral-primary-medium border border-default-medium rounded-base shadow-lg w-72`}>
                        <div className="p-2">
                        ...
                        <ul className="px-2 pb-2 text-sm text-body font-medium" aria-labelledby="dropdownAvatarNameButton">
                            <li className="hover:bg-gray-500">
                                <Link href='/dashboard' onClick={() => setShowDropDown(false)} className="inline-flex items-center w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded">
                            ...
                            <li className="hover:bg-gray-500">
                                <Link href={session.user.name} onClick={() => setShowDropDown(false)} className="inline-flex items-center w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded">
                            ...
                            <li className="hover:bg-gray-500">
                                <button onClick={() => { setShowDropDown(false); signOut({ callbackUrl: '/login' }) }} className="inline-flex items-center w-full p-2 text-fg-danger hover:bg-neutral-tertiary-medium rounded">
